...
import { useContent, type Project } from "@/hooks/useContent";
...
export default function LandingPageTemplate({ projectId }: LandingPageTemplateProps) {
                  ...
                  <div>
                    ...
                    <div className="flex gap-4">
                      <button
                        ...
                        className={`flex-1 py-3 md:py-2 px-4 rounded-lg font-medium transition-all w-6 h-6 ${
